    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        {currentUser?.role !== "Sales Representative" && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white text-sm font-bold rounded-lg transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
          ...
          <div className="md:col-span-4 relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-sm text-white focus:outline-none focus:border-teal-500 transition-colors"
            />
          </div>
          ...
          <div className="md:col-span-2">
            <select
              ...
              className="w-full px-3 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-sm text-white focus:outline-none focus:border-teal-500 transition-colors appearance-none"
            >
                ...
                {processedLeads
                  ...
                  .map((lead) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <Badge
                          colorClass="bg-zinc-800 text-zinc-300 border border-zinc-700"
          ...
          <div className="px-4 py-3 border-t border-zinc-800 flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm text-zinc-400">
              ...
              <select
                ...
                className="bg-zinc-950 border border-zinc-800 rounded px-2 py-1 focus:outline-none focus:border-teal-500"
              >
            ...
            <div className="flex items-center gap-4 text-sm text-zinc-400">
              ...
              <div className="flex gap-1">
                <button
                  ...
                  disabled={page === 0}
                  className="px-2 py-1 hover:bg-zinc-800 rounded disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Prev
                </button>
                <button
      ...
      {drawerOpen && selectedLead && (
        <>
          ...
          ></div>
          <div className="fixed inset-y-0 right-0 w-full sm:w-[420px] bg-zinc-950 border-l border-zinc-800 z-50 flex flex-col shadow-2xl">
            <div className="p-4 border-b border-zinc-800 flex justify-between items-center bg-zinc-900/50">
              <div>
                <h3 className="font-bold text-white">Client Quick Review</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-teal-500 flex items-center justify-center text-zinc-950 font-bold text-xl">
              ...
              <div>
                <h5 className="flex items-center gap-2 font-bold text-white mb-3">
              ...
              <div>
                ...
                <p className="bg-orange-500/10 text-orange-200 border border-orange-500/20 rounded-xl p-4 text-sm italic">
                  {selectedLead.notes ||
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-900/50 flex flex-col gap-2">
              <button
                ...
                className="w-full py-2 bg-teal-500 hover:bg-teal-600 text-zinc-950 font-bold rounded-lg transition-colors"
              >
                Go to Workspace
              </button>
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 bg-transparent border border-zinc-700 hover:border-zinc-500 text-white font-bold rounded-lg transition-colors"
                >
                  Edit File
                </button>
                <button
            ...
            >
                ...
                >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-teal-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {salespeople.map((rep) => (
                        <option key={rep} value={rep}>
                          {rep}
              ...
              <div className="p-4 border-t border-zinc-800 bg-zinc-950 flex justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2 font-bold text-sm text-zinc-400 hover:text-white transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={addOpen ? handleSaveAdd : handleSaveEdit}
                  className="px-6 py-2 bg-teal-500 hover:bg-teal-600 text-zinc-950 text-sm font-bold rounded-lg transition-colors"
                >
